...
public class MenuBreakfast extends AppCompatActivity {
    ...
    private ArrayList<DataModelRecipe> dataholder;
    private SwipeRefreshLayout refreshLayout;
    private MyAdapterRecipe adapter;
    ...
    private void getBreakfast(){
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Constant.BREAKFAST, response -> {
            try {
                JSONObject object = new JSONObject(response);
                Log.d("qwerty", String.valueOf(object));
                if (object.getBoolean("success")){
                    db.deleteAllBreakfast();
                    JSONArray array = new JSONArray(object.getString("breakfast"));
                    for (int i = 0; i < array.length(); i++) {
                        JSONObject breakfastObject = array.getJSONObject(i);
                        ContentValues values = new ContentValues();
                        values.put(DbHelper.row_id_breakfast, breakfastObject.getString("id"));
                        values.put(DbHelper.row_user_id, breakfastObject.getString("id_user"));
                        values.put(DbHelper.row_name_breakfast, breakfastObject.getString("breakfast_name"));
                        values.put(DbHelper.row_calories, breakfastObject.getString("calories"));
                        values.put(DbHelper.row_duration, breakfastObject.getString("time"));
                        values.put(DbHelper.row_portion, breakfastObject.getString("portion"));
                        values.put(DbHelper.row_materials, breakfastObject.getString("materials"));
                        values.put(DbHelper.row_procedure, breakfastObject.getString("how_to_cook"));
                        values.put(DbHelper.row_image, breakfastObject.getString("photo"));
                        db.insertBreakfast(values);
                    }
                }else{
                    Toast.makeText(MenuBreakfast.this, "MACAMDLDLL", Toast.LENGTH_SHORT).show();
                }
            }catch (JSONException e){
                e.printStackTrace();
                Toast.makeText(MenuBreakfast.this, "TOLTOL", Toast.LENGTH_SHORT).show();
            }
        },error -> {
            error.printStackTrace();
            Toast.makeText(MenuBreakfast.this, "Easdasdss.", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(MenuBreakfast.this);
        queue.add(request);
    }
...
//        dataholder = new ArrayList<>();
//        dataholder.add(new DataModelRecipe
//                (1,"https://i0.wp.com/resepkoki.id/wp-content/uploads/2020/02/Resep-Bubur-Ayam-Cirebon.jpg",
//                        "Bubur Ayam",
//                        "200 kkal",
//                        "45 menit",
//                        "4 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (2,"https://i0.wp.com/resepkoki.id/wp-content/uploads/2017/11/Resep-Pancake-pisang.jpg",
//                        "Pancake Oat Pisang",
//                        "170 kkal",
//                        "20 menit",
//                        "3 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (3,"https://cdn.yummy.co.id/content-images/images/20200508/HZ5sbHlHWh95ivBzKufzyV9gUMV9e6mm-31353838393132393536d41d8cd98f00b204e9800998ecf8427e_800x800.jpg",
//                        "Sayur Bening Bayam",
//                        "120 kkal",
//                        "35 menit",
//                        "2 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (4,"https://doyanresep.com/wp-content/uploads/2020/05/resep-tumis-kangkung.jpg",
//                        "Tumis Kangkung",
//                        "110 kkal",
//                        "25 menit",
//                        "1 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (5,"https://th.bing.com/th/id/R9537d47eaca7b700c40c2ed0730cb90c?rik=8WO%2bqP%2fpcZb9BQ&riu=http%3a%2f%2f3.bp.blogspot.com%2f-7KAE855PopQ%2fU5fsMYs0N2I%2fAAAAAAAABes%2fsPKyQWatGAM%2fs1600%2forakariksayurtelurasin1.jpg",
//                        "Telur Orak-Arik",
//                        "197 kkal",
//                        "10 menit",
//                        "1 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (6,"https://i.pinimg.com/originals/ce/20/f7/ce20f74d216e6a6174b0c5d3ffe1c1df.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (7,"https://images.immediate.co.uk/production/volatile/sites/30/2020/08/recipe-image-legacy-id-488467_11-9b2e34a.jpg?quality=90&webp=true&resize=375,341",
...
//
//        dataholder.add(new DataModelRecipe
//                (8,"https://cdns.klimg.com/merdeka.com/i/w/news/2020/06/16/1188018/content_images/670x335/20200616120450-1-8-resep-makanan-sehat-untuk-diet-rendah-kalori-dan-bernutrisi-tinggi-007-ayu-isti.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (9,"https://cdns.klimg.com/merdeka.com/i/w/news/2020/06/16/1188018/content_images/670x335/20200616120451-1-8-resep-makanan-sehat-untuk-diet-rendah-kalori-dan-bernutrisi-tinggi-006-ayu-isti.jpg",
//                        "Tahu Kukus Tuna",
//                        "188 kkal",
//                        "35 menit",
//                        "3 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (10,"https://image.freepik.com/free-photo/yogurt-oatmeal-with-fresh-berries-chia-seeds_80090-2188.jpg",
//                        "Oatmeal Yoghurt",
//                        "207 kkal",
//                        "15 menit",
//                        "1 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (11,"https://images.immediate.co.uk/production/volatile/sites/30/2020/08/soup-2981d19.png?quality=90&webp=true&resize=440,400",
//                        "Sup Wortel & Tomat",
//                        "175 kkal",
//                        "1 jam 30 menit",
//                        "8 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//        (12,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2019%2F08%2F26232751%2F3748796.jpg",
//                "Creamsicle Smoothie",
//                "184 kkal",
//                "5 menit",
//                "2 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (15,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2019%2F02%2F28%2F6417938.jpg",
//                        "Kue Peach Cobbler",
//                        "211 kkal",
//                        "55 menit",
//                        "12 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (16,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2018%2F02%2F21%2F5177837.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (17,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2018%2F03%2F27%2F5467915.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (18,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2019%2F08%2F26232655%2F3747401.jpg",
//                        "Empanaditas Nanas",
//                        "68 kkal",
//                        "1 jam 15 menit",
//                        "1 porsi",
...
//
//        dataholder.add(new DataModelRecipe
//                (19,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2019%2F02%2F03%2F6343096.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (20,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2018%2F02%2F23%2F5180252.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (19,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2016%2F07%2F12%2F3759444.jpg",
...
//
//        dataholder.add(new DataModelRecipe
//                (20,"https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2021%2F02%2F03%2Fstrawberry-banana-smoothies-2000.jpg",
